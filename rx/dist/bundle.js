...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_rx__ = __webpack_require__(1);
...
var source = __WEBPACK_IMPORTED_MODULE_0_rx___default.a.DOM.geolocation.getCurrentPosition();

var getPosition$ = source.subscribe(function (pos) {

    var getData$ = __WEBPACK_IMPORTED_MODULE_0_rx___default.a.DOM.get('https://fcc-weather-api.glitch.me/api/current?lat=' + pos.coords.latitude + '&lon=' + pos.coords.longitude).subscribe(function (data) {
        var data = JSON.parse(data.response);
        var root = document.querySelector('#root');
        var tpl = '\n                        <h1>Free Code Camp Weather App</h1>\n                        <p>' + data.name + '</p>\n                        <p>' + data.main.temp + '\xB0C</p>\n                    ';
