...
var ModuleWeather = function () {
    function ModuleWeather() {
        _classCallCheck(this, ModuleWeather);
    }

    _createClass(ModuleWeather, [{
        key: 'init',
        value: function init() {
            this.getData();
        }
        ...
        value: function getData() {
            ...
            this.getPosition().then(function (position) {
                ...
                __WEBPACK_IMPORTED_MODULE_0_axios___default.a.get('https://fcc-weather-api.glitch.me/api/current?lat=' + position.coords.latitude + '&lon=' + position.coords.longitude).then(function (response) {
                    _this.setWeather(response.data);
